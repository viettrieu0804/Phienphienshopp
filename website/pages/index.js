...
const HomeFirstBox = dynamic(() =>
  import("../app/components/Home/HomeFirstBox")
);
const HomeSeccoundBoxs = dynamic(() =>
  import("../app/components/Home/HomeSeccoundBoxs")
);
const HomeOfferList = dynamic(() =>
  import("../app/components/Home/HomeOfferList")
);
const HomeProductsFirst = dynamic(() =>
  import("../app/components/Home/HomeProductsFirst")
);
