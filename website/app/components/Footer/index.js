      ...
      <div className=" container-custom grid grid-cols-12">
        <div className="md:col-span-3 order-12  md:order-1  sm:py-0 py-5 col-span-12 !text-white">
          <Image
            ...
            alt="Logo"
          />
          <h4 className="text-white text-lg mt-2 mb-2">{settings.company}</h4>
          <p className="mb-2">{settings.description}</p>
          <Image
            ...
            footerMenu.map((val) => (
              <li key={val.title} className="mt-2 text-left">
                {!val.children ? (
                  ...
                  <>
                    <span className="text-white text-2xl font-normal uppercase">
                      {val.title}
                    </span>
